...
**Вхідні дані:**
* `w` — *(відстань між опорами, вказана у першому рядку)*
* `heights` — *(масив з N чисел, що описують максимальну можливу висоту для кожної опори, вказаний у другому рядку)*.
